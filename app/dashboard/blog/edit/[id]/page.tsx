...
export default function EditBlogPage() {
  ...
  const { editBlog, getBlogById } = useBlogs()
  ...
  useEffect(() => {
    const loadBlog = async () => {
      try {
        ...
        if (!blog) {
          blog = await getBlog(blogId) || undefined
        }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: formData.published ? "Your changes are now live" : "Your draft has been saved",
      })
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-primary/70 mt-2">Update your blog post</p>
        </div>
      </div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    disabled={isSubmitting}
                  />
                  <p className="text-xs text-primary/60 mt-1">URL-friendly version of the title</p>
                </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="border-secondary">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <Label htmlFor="published" className="text-primary">Published</Label>
                  <Switch
                    id="published"
